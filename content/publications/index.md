...
https://www.biorxiv.org/content/10.64898/2026.02.04.703695v1.abstract

In this work, we explore the forces shaping bacterial pangenomes. We develop a novel pangenome simulator, [Pansim](https://github.com/bacpop/Pansim), fitting it to pairwise genome distances generated by [PopPUNK](https://pmc.ncbi.nlm.nih.gov/articles/PMC6360808/) using Approximate Bayesian Computation implemented in [PopPUNK-mod](https://github.com/samhorsfield96/PopPUNK-mod).

### PanBART

Preprint coming soon

In this work, we train an attention-based model, [PanBART](https://github.com/samhorsfield96/panBART) on representations of gene-order in bacterial genomes, using 100,000s genomes. We explore the model's application to studying epidemiology and evolution of bacterial species.
